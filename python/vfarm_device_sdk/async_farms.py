...
class AsyncFarmApiMixin:
    async def list_farms(
        ...
        *,
        ...
        .. code-block:: python
           ...
           page = await client.list_farms(is_active=True, limit=20)
           print(page.total)
    ...
    async def get_farm(self, farm_id: str) -> FarmResponse:
        ...
        .. code-block:: python
           ...
           farm = await client.get_farm("farm-a")
           print(farm.name)
    ...
    async def create_farm(
        ...
        *,
        ...
        .. code-block:: python
           ...
           farm = await client.create_farm(farm_id="farm-a", name="Farm A")
           print(farm.id)
    ...
    async def update_farm(
        ...
        *,
        ...
        .. code-block:: python
           ...
           farm = await client.update_farm("farm-a", address="123 Field Rd")
           print(farm.address)
    ...
    async def delete_farm(self, farm_id: str) -> None:
        ...
        .. code-block:: python
           ...
           await client.delete_farm("farm-a")
    ...
    async def reactivate_farm(self, farm_id: str) -> FarmResponse:
        ...
        .. code-block:: python
           ...
           farm = await client.reactivate_farm("farm-a")
    ...
    async def deactivate_farm(self, farm_id: str) -> FarmResponse:
        ...
        .. code-block:: python
           ...
           farm = await client.deactivate_farm("farm-a")
           print(farm.is_active)
    ...
    async def ensure_farm(
        ...
        *,
        ...
        .. code-block:: python
           ...
           farm = await client.ensure_farm(farm_id="farm-a", name="Farm A")
           print(farm.id)
    ...
    async def iter_farms(
        ...
        *,
        ...
        .. code-block:: python
           ...
           async for farm in client.iter_farms(page_size=50):
               print(farm.id)
