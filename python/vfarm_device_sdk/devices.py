...
class DeviceApiMixin:
    def register_device(self, payload: DeviceCreate) -> DeviceCreatedResponse:
        ...
        .. code-block:: python
           ...
           created = client.register_device(DeviceCreate(id="sensor-001", farm_id="farm-a", device_type="sensor"))
    ...
    def get_device(self, device_id: str) -> DeviceResponse:
        ...
        .. code-block:: python
           ...
           device = client.get_device("sensor-001")
    ...
    def list_devices(
        ...
        *,
        ...
        .. code-block:: python
           ...
           page = client.list_devices(farm_id="farm-a", limit=50, offset=0)
    ...
    def list_offline_devices(self, *, limit: int = 100) -> DeviceListResponse:
        ...
        .. code-block:: python
           ...
           offline = client.list_offline_devices(limit=25)
           print(offline.total)
    ...
    def list_unhealthy_devices(self, *, threshold: int = 80, limit: int = 100) -> DeviceListResponse:
        ...
        .. code-block:: python
           ...
           bad = client.list_unhealthy_devices(threshold=70, limit=20)
           print(bad.total)
    ...
    def update_device(self, device_id: str, payload: DeviceUpdate) -> DeviceResponse:
        ...
        .. code-block:: python
           ...
           updated = client.update_device("sensor-001", DeviceUpdate(notes="Moved to rack-b"))
           print(updated.notes)
    ...
    def delete_device(self, device_id: str) -> None:
        ...
        .. code-block:: python
           ...
           client.delete_device("sensor-001")
    ...
    def send_device_heartbeat(self, device_id: str) -> DeviceHeartbeatResponse:
        ...
        .. code-block:: python
           ...
           hb = client.send_device_heartbeat("sensor-001")
           print(hb.status)
    ...
    def register_devices_batch(self, devices: list[DeviceBatchCreateItem]) -> DeviceBatchRegisterResponse:
        ...
        .. code-block:: python
           ...
           result = client.register_devices_batch([DeviceBatchCreateItem(id="sensor-002", farm_id="farm-a", device_type="sensor")])
    ...
    def get_device_metadata(self, device_id: str) -> DeviceMetadataResponse:
        ...
        .. code-block:: python
           ...
           meta = client.get_device_metadata("sensor-001")
           print(meta.metadata)
    ...
    def update_device_metadata(self, device_id: str, metadata: dict[str, object]) -> DeviceMetadataUpdateResponse:
        ...
        .. code-block:: python
           ...
           result = client.update_device_metadata("sensor-001", {"zone": "north"})
    ...
    def ensure_device(self, payload: DeviceCreate) -> EnsureDeviceResult:
        ...
        .. code-block:: python
           ...
           ensured = client.ensure_device(DeviceCreate(id="sensor-001", farm_id="farm-a", device_type="sensor"))
