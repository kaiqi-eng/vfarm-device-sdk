...
class AsyncAlertsApiMixin:
    async def list_alert_channels(
        ...
        *,
        ...
        .. code-block:: python
           ...
           channels = await client.list_alert_channels(enabled=True, limit=20)
    ...
    async def get_alert_channel(self, channel_id: str) -> AlertChannelResponse:
        ...
        .. code-block:: python
           ...
           channel = await client.get_alert_channel("channel-1")
           print(channel.id)
    ...
    async def create_alert_channel(
        ...
        *,
        ...
        .. code-block:: python
           ...
           channel = await client.create_alert_channel(payload)
           print(channel.id)
    ...
    async def update_alert_channel(self, channel_id: str, payload: AlertChannelUpdate) -> AlertChannelResponse:
        ...
        .. code-block:: python
           ...
           updated = await client.update_alert_channel("channel-1", payload)
    ...
    async def delete_alert_channel(self, channel_id: str) -> None:
        ...
        .. code-block:: python
           ...
           await client.delete_alert_channel("channel-1")
    ...
    async def test_alert_channel(self, channel_id: str) -> AlertTestResponse:
        ...
        .. code-block:: python
           ...
           result = await client.test_alert_channel("channel-1")
           print(result.status)
    ...
    async def enable_alert_channel(self, channel_id: str) -> AlertChannelResponse:
        ...
        .. code-block:: python
           ...
           channel = await client.enable_alert_channel("channel-1")
    ...
    async def disable_alert_channel(self, channel_id: str) -> AlertChannelResponse:
        ...
        .. code-block:: python
           ...
           channel = await client.disable_alert_channel("channel-1")
           print(channel.enabled)
    ...
    async def list_alert_rules(
        ...
        *,
        ...
        .. code-block:: python
           ...
           rules = await client.list_alert_rules(limit=20)
           print(rules.total)
    ...
    async def get_alert_rule(self, rule_id: str) -> AlertRuleResponse:
        ...
        .. code-block:: python
           ...
           rule = await client.get_alert_rule("rule-1")
           print(rule.id)
    ...
    async def create_alert_rule(
        ...
        *,
        ...
        .. code-block:: python
           ...
           rule = await client.create_alert_rule(payload)
           print(rule.id)
    ...
    async def update_alert_rule(self, rule_id: str, payload: AlertRuleUpdate) -> AlertRuleResponse:
        ...
        .. code-block:: python
           ...
           updated = await client.update_alert_rule("rule-1", payload)
           print(updated.enabled)
    ...
    async def delete_alert_rule(self, rule_id: str) -> None:
        ...
        .. code-block:: python
           ...
           await client.delete_alert_rule("rule-1")
    ...
    async def enable_alert_rule(self, rule_id: str) -> AlertRuleResponse:
        ...
        .. code-block:: python
           ...
           rule = await client.enable_alert_rule("rule-1")
           print(rule.enabled)
    ...
    async def disable_alert_rule(self, rule_id: str) -> AlertRuleResponse:
        ...
        .. code-block:: python
           ...
           rule = await client.disable_alert_rule("rule-1")
           print(rule.enabled)
    ...
    async def iter_alert_channels(self, *, enabled: bool | None = None, page_size: int = 100) -> AsyncIterator[AlertChannelResponse]:
        ...
        Returns
        -------
        AsyncIterator[AlertChannelResponse]
        ...
        .. code-block:: python
           ...
           async for channel in client.iter_alert_channels(page_size=50):
               print(channel.id)
    ...
    async def iter_alert_rules(self, *, enabled: bool | None = None, page_size: int = 100) -> AsyncIterator[AlertRuleResponse]:
        ...
        Returns
        -------
        AsyncIterator[AlertRuleResponse]
            Alert rule iterator.
        ...
        .. code-block:: python
           ...
           async for rule in client.iter_alert_rules(page_size=50):
               print(rule.id)
    ...
    async def iter_alert_history(
        ...
        *,
        ...
        .. code-block:: python
           ...
           async for row in client.iter_alert_history(page_size=100):
               print(row.id)
