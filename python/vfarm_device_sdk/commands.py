...
class CommandApiMixin:
    ...
    def _merge_payload_extra(
        ...
        .. code-block:: python
           ...
           merged = CommandApiMixin._merge_payload_extra({"target": "relay"}, {"target": "fan"})
           print(merged["target"])
    ...
    def list_device_commands(
        ...
        *,
        ...
        .. code-block:: python
           ...
           page = client.list_device_commands("sensor-001", status="pending")
           print(page.total)
    ...
    def create_command(
        ...
        *,
        ...
        .. code-block:: python
           ...
           cmd = client.create_command("sensor-001", CommandCreate(command_type="custom", payload={"action": "sync"}))
           print(cmd.id)
    ...
    def update_command_status(
        ...
        .. code-block:: python
           ...
           updated = client.update_command_status("sensor-001", "cmd-1", CommandAcknowledge(status="acknowledged"))
    ...
    def cancel_command(self, device_id: str, command_id: str) -> None:
        ...
        .. code-block:: python
           ...
           client.cancel_command("sensor-001", "cmd-1")
    ...
    def enqueue_config_update(
        ...
        *,
        ...
        .. code-block:: python
           ...
           cmd = client.enqueue_config_update("sensor-001", changes={"poll_interval_s": 30})
    ...
    def enqueue_restart_service(
        ...
        *,
        ...
        .. code-block:: python
           ...
           cmd = client.enqueue_restart_service("sensor-001", reason="firmware apply")
           print(cmd.id)
    ...
    def enqueue_set_state(
        ...
        *,
        ...
        .. code-block:: python
           ...
           cmd = client.enqueue_set_state("sensor-001", target="relay-1", state="on")
           print(cmd.command_type)
    ...
    def enqueue_set_value(
        ...
        *,
        ...
        .. code-block:: python
           ...
           cmd = client.enqueue_set_value("sensor-001", target="fan-speed", value=42.0, unit="percent")
           print(cmd.id)
    ...
    def enqueue_custom(
        ...
        *,
        ...
        .. code-block:: python
           ...
           cmd = client.enqueue_custom("sensor-001", action="sync_profile", params={"profile": "eco"})
           print(cmd.command_type)
